                                                        ...
                                                        <table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                                <td class="pad" style="width:100%;">
                                                                    <div class="alignment" align="center" style="line-height:10px"><img src="https://californiapublicite.ma/_next/image?url=%2Fassets%2Fimages%2Flogo.png&w=384&q=75" style="display: block; height: auto; border: 0; max-width: 190px; width: 100%;" width="190"></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table class="heading_block block-2" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                                <td class="pad">
                                                                    ...
                                                                    Email du California Pub Website
                                                                    </span></h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                        <p>Email : ${email}</p>
                                                                        <p>Nom complet : ${full_name}</p>
                                                                        <p>Entreprise : ${entreprise}</p>
                                                                        <p>Numéro de téléphone : ${phone_nbr}</p>
