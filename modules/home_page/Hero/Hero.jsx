      ...
      >
        ...
        <div className="flex gap-4 mt-4 md:mt-8">
          <ScrollLink
            ...
            offset={-10}
            duration={500}
            className="inline-block px-6 py-3 text-sm font-bold text-center text-black transition duration-300 ease-in-out rounded cursor-pointer bg-mainYellowColor hover:bg-amber-300 focus:outline-none focus:ring focus:ring-yellow-400 hover:scale-105 "
          ...
          <ScrollLink
            ...
            offset={-10}
            duration={500}
            className="inline-block px-6 py-3 text-sm font-bold text-center transition duration-300 ease-in-out rounded cursor-pointer bg-mainYellowColorh text-mainYellowColor hover:bg-amber-300n focus:outline-none focus:ring focus:ring-yellow-400 hover:scale-105"
          >
