...
const Services = () => {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1661956602116-aa6865609028?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=764&q=80",
      link: "Découpe-laser-et-CNC-router",
    },
    {
      title: "Découpe vinyl",
      description:
    ...
    <section id="Services" className="bg-gray-900 text-white secBg">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        <div className="mt-12 text-center">
          <Link
            href="#"
            className="mt-8 inline-block rounded bg-mainYellowColor px-12 py-3 md:text-lg font-medium dark:text-black transition hover:bg-amber-300 focus:outline-none focus:ring hover:scale-105 duration-300 focus:ring-red-700"
          >
            Démarrer maintenant
          </Link>
        </div>
